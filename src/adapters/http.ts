...
//
// Endpoints:
//   POST /process-input  { text, userId? }  → { systemContext, dynamicContext, stimulus, policyModifiers?, subjectivityKernel?, responseContract?, generationControls?, sessionBridge?, writebackFeedback?, throngletsExports?, policyContext }
