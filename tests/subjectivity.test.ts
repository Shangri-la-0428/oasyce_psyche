    ...
    const kernel = computeSubjectivityKernel(makeState({
      dyadicFields: {
        _default: {
          ...
          openLoops: [{ type: "unrepaired-breach", intensity: 0.9, ageTurns: 2 }],
          lastMove: "breach",
          updatedAt: now,
        },
      },
    ...
    const kernel = computeSubjectivityKernel(makeState({
      ...
      dyadicFields: {
        _default: {
          ...
          openLoops: [{ type: "unrepaired-breach", intensity: 0.7, ageTurns: 1 }],
          updatedAt: now,
          lastMove: "breach",
        },
      },
    ...
    const kernel = computeSubjectivityKernel(makeState({
      dyadicFields: {
        _default: {
          ...
          silentCarry: 0.64,
          openLoops: [{ type: "unrepaired-breach", intensity: 0.46, ageTurns: 2 }],
          updatedAt: now,
          lastMove: "repair",
        },
      },
