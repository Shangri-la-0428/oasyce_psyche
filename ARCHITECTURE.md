...
| 检测维度 | 模块 | 机制 |
|---------|------|------|
| 行为后果 | `decision-bias.ts` | PolicyModifiers: 情绪→结构化行为策略 |
| 不可逆痕迹 | `drives.ts` | TraitDrift: 基线漂移+衰减修饰+敏感度修饰 |
...
src/
  ...
  types.ts             — 类型定义、常量、化学名称（PsycheState v7）
...
v7.0 adds six capability layers on top of the chemical foundation: Emotional Learning (P3), Temporal Consciousness (P4), Metacognition & Decision Modulation (P5), Digital Personhood (P6), Autonomic Nervous System (P7), and Circadian Rhythms (P12).
