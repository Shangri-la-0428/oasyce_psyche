...
[English version below](#architecture--psyche-ai-v21)
...
## Compact Mode Prompt 架构（v2.2）

Compact Mode 的 prompt 注入按 10 个功能段落组织，按需出现：
...
## Compact Mode Prompt Architecture (v2.1)

The Compact Mode prompt injection uses 9 functional sections, appearing on demand:
...
If user shares feelings...      ← 9. Empathy report instruction
```
...
src/
  ...
  prompt.ts         — Prompt injection (9-section architecture)
